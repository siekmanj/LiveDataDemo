...
socket.on('nodeupdate', function(data){
    for(var i in data){
        ...
        nodestring += "TEMPONE:   <b>" + data[i].temp1 + "C</b><br>";
        nodestring += "TEMPTWO:   <b>" + data[i].temp2 + "C</b><br>";
        nodestring += "TEMPTHREE: <b>" + data[i].temp3 + "C</b><br>";
        ...
        nodestring += "DS DIRECT: <b>" + data[i].direction + "</b><br>";
        nodestring += "VISIBLE:   <b>" + data[i].VB + "</b><br>";
        nodestring += "IR:        <b>" + data[i].IR + "</b><br>";
        nodestring += "UV:        <b>" + data[i].UV + "</b><br>";
        nodestring += "</div>";
